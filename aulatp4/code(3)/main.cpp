...
void renderScene(void) {
	...
	char title[20];
	sprintf(title, "FPS: %d", fps); // Formata a string com o FPS
...
// Callback registration for keyboard processing
	...
	glBindBuffer(GL_ARRAY_BUFFER, indexes[0]);
	glVertexPointer(3, GL_FLOAT, 0, 0);

	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, indexes[0]);
	// count 120??
	glDrawElements(GL_TRIANGLES, 120, GL_UNSIGNED_INT, NULL);
